package sam.rdev.sayurku.network

import sam.rdev.sayurku.activity.data_barang.data.ResultDataBarang
import sam.rdev.sayurku.activity.login.data.ResultLogin
import sam.rdev.sayurku.activity.penjualan.data.ResultKeranjang
import sam.rdev.sayurku.activity.penjualan.data.ResultSearchBarang
import sam.rdev.sayurku.activity.report.detail.data.ResultItemKeranjang
